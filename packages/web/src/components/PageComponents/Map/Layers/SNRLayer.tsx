...
function upsertPair(
  ...
  idToLngLat: Map<number, [number, number]>,
): void {
...
export const SourceNeighborLines = ({ data }: { data: FeatureCollection }) => {
  return (
    <Source id="neighbor-lines" type="geojson" data={data}>
      <Layer
